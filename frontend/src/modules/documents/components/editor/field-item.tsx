...
import { Trash2, PenTool, Type, Calendar } from "lucide-react"
...
export function FieldItem({ field }: FieldItemProps) {
  ...
  return (
    <div
      ref={itemRef}
      className={cn(
        "absolute pointer-events-auto cursor-grab active:cursor-grabbing group flex items-center gap-2 border-2 transition-shadow",
        isSelected
